...
3. **README: specs and firmware.**
   ...
   - The two go together: BIOS 2.x has no font in ROM, and needs a PICOVDP firmware
     version with the built-in font. Flash the card first, or the console is blank.
